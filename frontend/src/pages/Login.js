        ...
        <div className="relative z-10 w-full max-w-md animate-fade-up">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400 text-sm mt-1">Sign in to your CollabConnect account</p>
            </div>
            ...
            <div className="flex justify-center">
              <GoogleLogin onSuccess={handleGoogleSuccess} onError={() => setError('Google login failed.')} theme="filled_black" size="large" width="100%" text="signin_with" />
            </div>

            <p className="text-center text-slate-500 text-sm mt-6">
              Don't have an account?{' '}
              <Link to="/signup" className="text-indigo-400 hover:text-indigo-300 font-semibold transition-colors">Sign up</Link>
            </p>
          </div>
        </div>
      </div>
